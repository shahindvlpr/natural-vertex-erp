...
@section('title', 'Edit Permission - Natural Vertex ERP')
...
<div style="background:#fff; border:1px solid #e8eaed; max-width:600px; margin:0 auto;">
    <div style="padding:16px 20px; border-bottom:1px solid #e8eaed;">
        <h5 style="margin:0; font-size:16px; font-weight:600;">
            <i class="fas fa-key" style="color:#6c5ce7;"></i> Edit Permission: {{ $permission->name }}
        </h5>
    </div>
    ...
    <div style="padding:20px;">
        ...
        <form action="{{ route('permissions.update', $permission->id) }}" method="POST">
            ...
            <div style="margin-bottom:16px;">
                ...
                <textarea name="description" rows="2" style="width:100%; padding:9px 14px; font-size:13px; border:1px solid #e8eaed; background:#fff; color:#1a1a2e;">{{ old('description', $permission->description) }}</textarea>
            </div>
