...
@section('title', 'Edit Supplier - Natural Vertex ERP')
...
<div class="form-card">
    <div class="form-card-header">
        <h5 style="margin:0; font-size:16px; font-weight:600;">
            <i class="fas fa-edit" style="color:#6c5ce7;"></i> Edit Supplier: {{ $supplier->name }}
        </h5>
    </div>
        ...
        <form action="{{ route('supplier.update', $supplier->id) }}" method="POST">
            ...
            <div class="row-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="website" class="form-control" value="{{ old('website', $supplier->website) }}" placeholder="https://example.com">
                </div>
            ...
            <div class="form-group">
                <label style="display:flex; align-items:center; gap:8px; font-size:13px; cursor:pointer;">
                    <input type="checkbox" name="is_active" {{ old('is_active', $supplier->is_active) ? 'checked' : '' }}>
