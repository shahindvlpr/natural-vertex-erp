...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card border-0 shadow-sm bg-white">
        <div class="card-body p-0">
            <form action="{{ route('warehouse.receive.store') }}" method="POST">
                @csrf
                
                <!-- Form Header -->
                <div class="px-4 py-3 border-bottom bg-light">
                    <h6 class="mb-0 text-muted fw-bold text-uppercase small">Receive Information</h6>
                </div>
                ...
                <div class="px-4 py-4">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <label for="reference" class="form-label fw-bold text-muted small text-uppercase">Reference (e.g. PO #)</label>
                            <input type="text" name="reference" id="reference" value="{{ old('reference') }}" class="form-control bg-light border-0 py-2" placeholder="PO-12345">
                        </div>
                    </div>
                </div>
                ...
                <div class="px-4 py-3 border-top bg-light d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-success px-4 shadow-sm hover-lift">
