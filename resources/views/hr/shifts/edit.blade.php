...
@section('title', 'Edit Shift - Natural Vertex ERP')
...
<div class="form-card">
    <div class="form-card-header">
        <h5 style="margin:0; font-size:16px; font-weight:600;">
            <i class="fas fa-edit" style="color:#6c5ce7;"></i> Edit Shift: {{ $shift->name }}
        </h5>
    </div>
    ...
    <div class="form-card-body">
        ...
        <form action="{{ route('hr.shifts.update', $shift->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="break_duration" value="{{ old('break_duration', $shift->break_duration) }}" class="form-control" min="0">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="shift_type" class="form-control" required>
                    ...
                    <option value="flexible" {{ old('shift_type', $shift->shift_type) == 'flexible' ? 'selected' : '' }}>Flexible</option>
                </select>
            </div>
            ...
            <div class="form-group">
                <label style="display:flex; align-items:center; gap:8px; font-size:13px; cursor:pointer;">
                    <input type="checkbox" name="is_active" {{ old('is_active', $shift->is_active) ? 'checked' : '' }}>
