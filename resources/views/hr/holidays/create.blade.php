...
@section('title', 'Create Holiday - Natural Vertex ERP')
...
<div class="form-card">
    <div class="form-card-header">
        <h5 style="margin:0; font-size:16px; font-weight:600;">
            <i class="fas fa-plus-circle" style="color:#6c5ce7;"></i> Create Holiday
        </h5>
    </div>
        ...
        <form action="{{ route('hr.holidays.store') }}" method="POST">
            ...
            <div class="form-group">
                <label style="display:flex; align-items:center; gap:8px; font-size:13px; cursor:pointer;">
                    <input type="checkbox" name="is_paid" {{ old('is_paid', true) ? 'checked' : '' }}>
