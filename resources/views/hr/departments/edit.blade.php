...
@section('title', 'Edit Department - Natural Vertex ERP')
...
<div class="form-card">
    <div class="form-card-header">
        <h5 style="margin:0; font-size:16px; font-weight:600;">
            <i class="fas fa-edit" style="color:#6c5ce7;"></i> Edit Department: {{ $department->name }}
        </h5>
    </div>
        ...
        <form action="{{ route('hr.departments.update', $department->id) }}" method="POST">
            ...
            <div class="form-group">
                <label style="display:flex; align-items:center; gap:8px; font-size:13px; cursor:pointer;">
                    <input type="checkbox" name="is_active" {{ old('is_active', $department->is_active) ? 'checked' : '' }}>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('hr.departments.index') }}" class="btn-cancel">
